    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0">
        ...
        <motion.div
          ...
          className="absolute top-1/2 h-48 w-full translate-y-12 scale-x-150 bg-stone-950 blur-2xl"
        ></motion.div>
        <motion.div
          initial={{ opacity: 0 }}
        ...
        <motion.div
          ...
          className="absolute inset-auto z-50 h-36 w-[28rem] -translate-y-1/2 rounded-full bg-amber-500 blur-3xl"
        ></motion.div>
        <motion.div
