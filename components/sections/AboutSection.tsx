...
const AboutSection = () => {
  return (
    <section id="about" className="relative w-full overflow-hidden bg-gradient-to-b from-stone-950 via-stone-900 to-stone-950">
      ...
      <LampContainer>
        ...
        >
          <h2 className="bg-gradient-to-br from-amber-200 via-amber-100 to-amber-300 bg-clip-text py-4 font-serif text-4xl font-medium tracking-tighter text-transparent md:text-6xl lg:text-7xl">
